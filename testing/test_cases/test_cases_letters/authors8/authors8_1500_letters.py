from new_testament_texts.letter_texts import P_letters as P, NP_letters as NP
...
jude = "^" + NP.jude + "*"
romans = "^" + P.romans + "*"
corinthians1 = "^" + P.corinthians1 + "*"
corinthians2 = "^" + P.corinthians2 + "*"
galatians = "^" + P.galatians + "*"
philemon = "^" + P.philemon + "*"
thessalonians1 = "^" + P.thessalonians1 + "*"
philippians = "^" + P.philippians + "*"
